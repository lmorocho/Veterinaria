            ...
            <form action="alta_cliente_destino.php" method="get">
                ...
                <div class="mb-3">
                    ...
                    <div class="input-group">
                        ...
                        <input type="text" class="form-control" placeholder="Escriba el Teléfono" aria-label="telefonocliente" required>
                    </div>
            ...
            <form action="alta_cliente_destino.php" method="get">
                ...
                <div class="mb-3">
                    ...
                    <select class="form-select" aria-label="Default select example">
                        <option selected>Seleccione Tipo de Mascota</option>
